...
Each function has its own file, but some functions may depend on others.
Each function also has a documentation file in the `doc` directory.
...
You can pass it the qsh function names you want, or files to scan for
qsh function names.
The script will output these qsh functions, along with any other qsh
